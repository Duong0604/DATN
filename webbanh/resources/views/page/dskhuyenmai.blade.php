			...
			<div class="row">
                ...
                <div class="col-sm-9">
					<div class="blog-post-area">
						<h2 class="title text-center">Tin khuyến mãi</h2>
                        @foreach($dskm as $km)
						<div style="border-bottom: 1px solid #eae3e3; height:160px;" class="single-blog-post">
							<a href="{{route('chitietkm',$km->id)}}"><h3>{{$km->promo_title}}</h3></a>
							{{-- <div class="post-meta">
								<ul>
							...
							<a href="{{route('chitietkm',$km->id)}}">
								<img style="width:100px; height:100px; border:none; margin: 0;float:left; margin-right:10px" src="{{url('/')}}/source/images/promotions/{{$km->image}}" alt="">
							</a>
