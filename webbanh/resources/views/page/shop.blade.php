  ...
  <section >
		<div class="container" >
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div  class="brands_products"><!--brands_products-->
							<h2>Loại sản phẩm</h2>
							<div style="border: 2px solid rgb(243, 238, 238);border-radius: 10px" class="brands-name">
				...
				<div style="border:2px solid rgb(243, 238, 238);border-radius: 10px" class="price-range"><!--price-range-->
