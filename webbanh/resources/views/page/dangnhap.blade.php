...
function testLocalStorageData() {
    if(!supportsHTML5Storage()) { return false; }
    localStorage.setItem("PROFILE_IMG_SRC", "//lh3.googleuser   .com/-6V8xOA6M7BA/AAAAAAAAAAI/AAAAAAAAAAA/rzlHcD0KYwo/photo.jpg?sz=120" );
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <a href="{{url('password/reset')}}" class="forgot-password">
             ...
             <a style="margin-left:125px" href="{{route('dangki')}}" class="forgot-password">
