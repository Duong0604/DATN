                    ...
                    <li class="submenu">
										...
										<li class="submenu">
												<a href="{{ route('quanlysanpham') }}">
														...
														<span class="caret pull-right"></span> Quản lí khuyến mãi
												</a>
										
												<ul>
															<li><a href="{{route('danhsachkhuyenmai')}}"><i class="glyphicon glyphicon-record"></i> Danh sách khuyến mãi</a></li>
												</ul>
												<ul>
															<li><a href="{{ route('themkhuyenmai') }}"><i class="glyphicon glyphicon-record"></i> Thêm khuyến mãi mới</a></li>
												</ul>
										</li>
										<li class="submenu">
												<a href="{{ route('quanlysanpham') }}">
