                ...
                <div class="div_form_thong_tin">
                    ...
                    @endif
                     ...
                     <script language="javascript" src="{{url('/')}}/admin/vendors/ckeditor/ckeditor.js" type="text/javascript"></script>
                      {!! Form::open(array('route'=>'postcapnhatkhuyenmai','id'=>'form_cap_nhat_san_pham','class' => 'form_cap_nhat_san_pham', 'files'=>true)) !!}
                                ...
                                <td>
                                 <select name="status">
                                  @if($thongtinsp->status==1)
                                    <option value="1" selected>Đang trưng bày</option>
                                      <option value="0" >Ngừng bán</option>
                                    @else
                                        <option value="1" >Đang trưng bày</option>
