     ...
     <div class="title_main_form_admin">
                ...
                <div class="thong_tin_don_hang">
                    ...
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        ...
                        {!! Form::hidden('status', $thongtindonhang->payment_status) !!}
                    ...
                    <div class="thong_tin_nguoi_nhan">
                        ...
                        <div class="trang_thai_don_hang">
                            <div class="thanh_chua_nut">
                              @if($thongtindonhang->status_order==1)
                                ...
                                @else
                                    @if($thongtindonhang->payment_status == 1)
                                        <div class="nut_trang_thai_don_hang_off">
                                            Chưa thanh toán
                                        </div>
                                    @else
                                        <div class="nut_trang_thai_don_hang_on">
                                            Đã thanh toán
                                        </div>
                                    @endif
                            @endif
                            ...
                            <table class="table_gio_hang" cellspacing="0" cellpadding="5" style="width:100%">
                                ...
                                @endforeach
                                  <tr class="tr_tong_tien">
                                    ...
                                    <td style="text-align: end;color:black" colspan="2">
                                        Thuế (10% VAT)
                                    </td>
                                    <td style="text-align: end;color:black">
                                    <?php $thue=0;
                                        $thue = ($tongtien*10)/100;
                                    ?>
                                       {{number_format($thue,0,",",".")}} VNĐ
                                    </td>
                                </tr>
                                @if(isset($km))
                                 <tr class="tr_tong_tien">
                                   ...
                                   @if($km->id_type_promo==1)
                                    -{{number_format($km->promo_value,0,",",".")}} VNĐ
                                    @else
                                    -{{$km->promo_value}} %
                                    @endif
                                    </td>
                                ...
                                <tr class="tr_tong_tien">
                                    ...
                                    <td style="text-align: end;color:blue" colspan="2">
                                        Tổng thành tiền
                                    </td>
                                    <td style="text-align: end;color:blue">
