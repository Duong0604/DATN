                    ...
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <table class="form_cap_nhat">
                            ...
                            <tr>
                                ...
                                <td>
                                <input style="width: 80%;padding: 5px 10px" disabled value="Admin" placeholder="Admin" name="power" type="text">
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <div class="ds_button_admin">
                            ...
                            <div class="btn_xoa" onclick="window.location='{{url('/')}}/admin/danh-sach-thanh-vien';">Quay lại</div>
