                    ...
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <table class="form_cap_nhat">
                            ...
                            <tr>
                                ...
                                <td>
                                @if($taikhoan->power==3)
                                <input type="text" disabled name="powername" value="super admin">
                                {!! Form::hidden('power', $taikhoan->power) !!}
                                @else
                                <?php array_pop ($dsquyen) ?>
                                ...
                                <td>
                                  ...
                                  @if($taikhoan->status==1)
                                    <option value="1" selected>Hoạt động</option>
                                      <option value="0" >Cấm hoạt động</option>
                                    @else
                                        <option value="1" >Hoạt động</option>
                                      <option value="0" selected>Cấm hoạt động</option>
                                @endif
                                </select>
                                    {{-- @if($taikhoan->status==1)
