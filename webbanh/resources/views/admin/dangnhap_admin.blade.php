...
<link rel="icon" href="{{url('/')}}/source/images/home/logo1.png" type="image/gif" sizes="16x16">
    ...
    <body>
        ...
        <div id="noidung">
            <div class="login" id="element-box">
                <div style="height: 250px" class="m wbg">
                    ...
                    <div id="section-box">
                        <div style="height: 120px" class="m">
                        {{-- @if(Session::has('flag'))
                        ...
                        @endif --}}
                            ...
                            <fieldset class="loginform">
                                ...
                                <input style="height: 30px;min-width: 205px; box-shadow: inset 0 1px 1px rgba(0,0,0,0.075)" required type="text" size="15" class="inputbox" id="login-username" name="email" value="">
                                <label for="login-password" id="login-password-lbl">Mật khẩu</label>
                                <input style="height: 30px;min-width: 205px; box-shadow: inset 0 1px 1px rgba(0,0,0,0.075)" required type="password" size="15" class="inputbox" id="login-password" name="password">
                                <div class="button-holder">
                                    <div class="button1">
                                        <div class="next">
                                            <input style="background-color: #179fd4;height: 35px;border: solid 1px #1facb6;color: white;border-radius: 5px;width: 300px"class="btndangnhap" type="submit" name="dangnhap" id="dangnhap" value="Đăng nhập">
                                        </div>
                    ...
                    <div id="lock">
                    <img src="{{url('/')}}/source/images/home/logo1.png" style="width:150px; height:145px">
                    </div>
                </div>
            </div>
        </div> <!-- nd -->
