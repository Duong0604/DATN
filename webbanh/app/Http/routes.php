...
Route::get('chitietkhuyenmai/{id}',[
	'as' =>'chitietkm',
	'uses' =>'PageController@getchitietkm'
]);
Route::get('tintuc',[
	'as' =>'tintuc',
...
Route::group(['middleware' =>'auth'] , function(){
	 ...
	 Route::post('checkout',[
		'as' => 'postmakm',
		'uses' => 'CheckoutController@postmakm'
	]);
...
Route::group(['prefix' => 'admin','middleware'=>'AminLogin'], function() {
	...
	Route::post('them-san-pham-moi-theo-size',[
	 ...
	 // quản lí khuyến mãi
	 Route::get('them-khuyen-mai-moi',[
		'as' => 'themkhuyenmai', 
		'uses' => 'AdminKhuyenMaiController@getthemkhuyenmai_admin'
	]);
	Route::post('them-khuyen-mai-moi',[
		'as' => 'postthemkhuyenmai', 
		'uses' => 'AdminKhuyenMaiController@postthemkhuyenmai_admin'
	]);
	Route::get('cap-nhat-khuyen-mai/{id}',[
		'as' => 'capnhatkhuyenmai', 
		'uses' => 'AdminKhuyenMaiController@getCapnhatkm_admin'
	]);
	Route::post('cap-nhat-khuyen-ma',[
		'as' => 'postcapnhatkhuyenmai', 
		'uses' => 'AdminKhuyenMaiController@postCapnhatkm_admin'
	]);
	Route::post('xoa-khuyen-ma',[
		'as' => 'postxoakhuyenmai', 
		'uses' => 'AdminKhuyenMaiController@postXoakm_admin'
	]);
	Route::get('danh-sach-khuyen-mai',[
		'as' => 'danhsachkhuyenmai', 
		'uses' => 'AdminKhuyenMaiController@danhsachkhuyenmai_admin'
	]);
});
