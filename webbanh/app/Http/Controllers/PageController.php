...
class PageController extends Controller
{
    ...
    public function shop(Request $request)
    {
        ...
        $sanpham = DB::table('product')->where('status','=',1)->select('id','name','image','price')->orderBy('id','DESC')->paginate(9);
...
//
    ...
    {
        $dskm = DB::table('promotions')->where('status',1)->paginate(8);
        return view('page.dskhuyenmai',['dskm'=>$dskm]);
    }
    public function getchitietkm($id)
    {
         $ctkm = DB::table('promotions')->where('status',1)->where('id',$id)->first();
        return view('page.chitietkm',['ctkm'=>$ctkm]);
    }
    //
